        ...
        <div class="col-md-8">
            <form action="">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php  foreach ($boo as  $va) { ?>
                        <tr>
                            <td><?php  echo $va['book_name']; ?></td>
                            <td><?php  echo $va['author_name']; ?></td>
                            <td><?php  echo $va['book_price']; ?></td>
                            <td><?php  echo $va['book_no']; ?></td>
                        </tr>
