...
$vie = $test->view_profile();

//update code
if(isset($_POST['update'])){
    $test->update_profile($_POST);
}
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                    <label>Name:</label>
                    <input type="text" name="name" class="form-control" value="<?php echo $vie['name'];  ?>" >
                </div>
                <div class="form-group">
                    <label>Email ID:</label>
                    <input type="email"  name="email" class="form-control" value="<?php echo $vie['email'];  ?>" >
                </div>
                <div class="form-group">
                    <label>Mobile Number:</label>
                    <input type="text"  name="mobile" class="form-control" value="<?php echo $vie['mobile'];  ?>" >
                </div>
                <div class="form-group">
                    <label>Address:</label>
                    <textarea rows="3" cols="40"  name="address" class="form-control"><?php echo $vie['address'];  ?></textarea>
                </div>
